...
module Hwtelemetry
  ...
  class Telemetry < ::ProtocolBuffers::Message
    ...
    optional :string, :mac_address, 17
  end
  ...
  class PathElem < ::ProtocolBuffers::Message
    # forward declarations
    class PathElemMap < ::ProtocolBuffers::Message; end

    set_fully_qualified_name "hwtelemetry.PathElem"

    # nested messages
    class PathElemMap < ::ProtocolBuffers::Message
      set_fully_qualified_name "hwtelemetry.PathElem.PathElemMap"
    ...
    repeated ::Hwtelemetry::PathElem::PathElemMap, :key, 2
  end
  ...
  class TelemetryThreshold < ::ProtocolBuffers::Message
    ...
    optional :uint64, :thresholdValue, 1
